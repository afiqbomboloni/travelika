            ...
            <div class="m-2 p-2 bg-gray-50 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.places.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-1">
                            <input type="number" id="price" name="price" min="0.00" max="10000000000"
                            class="block w-full transition duration-150 bg-white border border-gray-400 rounded-md py-1">
                        </div>
                        </div>
                        ...
                        <div class="mt-1">
                            ...
                            class="shadow-sm focus:ring-indigo-500 bg-white border border-gray-400 rounded-md py-2 w-full">
                        </textarea>
                        </div>
                    </div>
                    <div class="sm:col-span-6 pt-5">
